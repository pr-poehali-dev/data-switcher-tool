...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Раньше бухгалтер тратила по 2 дня в месяц на ручной пересчёт объектов и выставление счетов. Теперь всё это занимает 10 минут — система всё делает сама.",
      name: "Андрей Соколов",
      company: "Директор, ТрансЛогик",
      image:
    ...
    {
      quote:
        "Подключили 47 машин за один день. Клиенты сразу получили доступ к своему кабинету и видят транспорт онлайн. Вопросов по счетам стало в разы меньше.",
      name: "Елена Смирнова",
      company: "Оператор-бухгалтер, ГрузТелематика",
      image:
    ...
    {
      quote:
        "Наконец нашли платформу, где биллинг и мониторинг в одном месте. Больше не нужно дублировать данные между системами — всё синхронизировано автоматически.",
      name: "Игорь Васильев",
      company: "Технический директор, ФлотКонтроль",
      image:
